 ...
 * @description:
 * @author: shenlx
 * @create: 2023-04-14 17:13
 **/

import com.shenlx.xinwen.swagger2.api.model.BaseResponse;
import com.shenlx.xinwen.swagger2.api.model.LoginParam;
...
public class LoginController {
    ...
    public BaseResponse<String> login(@RequestHeader(name="Content-Type", defaultValue = "application/json") String contentType,
        ...
        return new BaseResponse<String>(true, "Login success", "JWT");
    }
    ...
    public BaseResponse unauthorized() {
        return new BaseResponse<String>(false, "Unauthorized", null);
    }
