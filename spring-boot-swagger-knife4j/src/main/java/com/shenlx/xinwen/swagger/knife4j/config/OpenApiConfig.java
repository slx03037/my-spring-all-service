package com.shenlx.xinwen.swagger.knife4j.config;

import com.github.xiaoymin.knife4j.spring.extension.OpenApiExtensionResolver;
import com.shenlx.xinwen.swagger.knife4j.enums.ResponseStatus;
...
public class OpenApiConfig {
    ...
    public Docket openApi() {
        String groupName = "Test Group Knife4j";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("shenlx", "http://baidu.com", "xxxx@gmail.com"))
