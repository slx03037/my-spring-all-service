package spring.boot.shiro.validate.controller;
...
import spring.boot.shiro.validate.properties.MyProperties;
import spring.boot.shiro.validate.service.ManagerInfoService;
import spring.boot.shiro.validate.shiro.ShiroKit;
import spring.boot.shiro.validate.shiro.exception.IncorrectCaptchaException;
