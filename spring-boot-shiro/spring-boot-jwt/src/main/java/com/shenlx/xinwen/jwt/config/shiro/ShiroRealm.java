package com.shenlx.xinwen.jwt.config.shiro;

import com.shenlx.xinwen.domain.JWTUser;
import com.shenlx.xinwen.jwt.config.jwt.JWTToken;
import com.shenlx.xinwen.jwt.config.jwt.JWTUtil;
import com.shenlx.xinwen.jwt.untils.SystemUtils;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection token) {
        ...
        JWTUser user = SystemUtils.getUser(username);
