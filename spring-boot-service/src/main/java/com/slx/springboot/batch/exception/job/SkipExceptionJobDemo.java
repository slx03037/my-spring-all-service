package com.slx.springboot.batch.exception.job;

import com.slx.springboot.batch.exception.exception.MyJobExecutionException;
import com.slx.springboot.batch.exception.listener.MySkipListener;
...
public class SkipExceptionJobDemo {
    ...
    //MySkipListener mySkipListener=new MySkipListener();
    @Autowired
