...
public class DataSourceItemReaderDemo {
    ...
    private ItemReader<BatchData> dataSourceItemReader() throws Exception {
        JdbcPagingItemReader<BatchData> reader = new JdbcPagingItemReader<>();
