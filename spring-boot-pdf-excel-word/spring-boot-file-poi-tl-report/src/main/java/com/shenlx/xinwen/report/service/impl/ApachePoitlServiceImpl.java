...
import com.shenlx.xinwen.report.model.*;
import com.shenlx.xinwen.report.service.ApachePoitlService;
import com.shenlx.xinwen.report.utils.OperateWordManage;
...
public class ApachePoitlServiceImpl implements ApachePoitlService {
    ...
    public void generateCharts() {
        ...
        picData.setWidth(200).setHeight(160).setPicType(PicTypeEnum.JPG).setFile(new File("D:\\workspace-github-project\\my-spring-all-service\\spring-boot-pdf-excel-word\\spring-boot-file-poi-tl-report\\src\\main\\resources\\file\\1.jpeg"))
        ...
        //生成word
        OperateWordManage.generateWordContent(templateFile, "D:\\workspace-github-project\\my-spring-all-service\\spring-boot-pdf-excel-word\\spring-boot-file-poi-tl-report\\src\\main\\resources\\file\\output.docx", generates);
    }
}
